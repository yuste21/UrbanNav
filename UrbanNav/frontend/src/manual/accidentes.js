    ...
    return (
        <>
            ...
            <p>
                ...
                información adicional sobre las zonas representadas. Al visitar esta página por primera vez o 
                tras una actualización, se realizará una carga inicial mostrando 10 accidentes por barrio.
            </p>
            ...
            <p>
                ...
                en forma de X posicionado en la esquina superior derecha o al pulsar fuera de la propia 
                ventana. Al hacer clic sobre el marcador de un accidente aparecerá la opción de 'Ver más 
                información' y al seleccionarla se verá una ventana modal con información sobre el accidente 
                y todas las personas implicadas en él. En este caso no aparecerá el formulario en la parte 
                inferior de la ventana modal.
            </p>

            <h2>4.2 Flujo de accidentes</h2>
            <p>
            ...
            <h2>Gráfica</h2>
            <p>
                Al seleccionar el icono correspondiente a las gráficas, se desplegarán dos tipos distintos 
                que categorizan los accidentes según diversas características. La gráfica de barras se enfoca 
                en los atributos de las personas involucradas en los accidentes, mientras que la gráfica 
                circular analiza aspectos inherentes a los propios accidentes. Al interactuar con una zona 
                específica del mapa, ambas gráficas se actualizarán para reflejar los datos de accidentes 
                pertinentes a esa área seleccionada.
            </p>

            <h2>Filtro</h2>
            <p>
                Al activar el icono del filtro, se desplegará un panel lateral que contiene un formulario detallado. 
                Este panel puede cerrarse seleccionando el botón con forma de 'X' situado en la esquina superior derecha 
                o haciendo clic fuera del área del menú. En la parte inferior del panel de filtro, encontrarás dos 
                opciones: 'Filtrar' y 'Limpiar filtro'. Al seleccionar 'Filtrar' sin completar los campos requeridos, 
                recibirás una notificación indicando 'Datos incompletos'. Si los campos están correctamente rellenados, 
                se procederá con la búsqueda según los criterios especificados. Al elegir 'Limpiar filtro', aparecerá un 
                mensaje preguntando si deseas volver a la carga inicial de datos. Aceptar este mensaje reiniciará la carga 
                de datos y limpiará el filtro. Si decides no aceptar, simplemente se borrarán los campos del formulario 
                sin iniciar una nueva búsqueda.
            </p>
        </>
    )
}
